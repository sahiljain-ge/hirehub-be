import type { StorageProvider, UploadOptions } from './providers/provider.types.js';
...
export const uploadFile = async (file: Express.Multer.File,options: UploadOptions = {}): Promise<FileOperationResponse> => {
  if (!file) {
